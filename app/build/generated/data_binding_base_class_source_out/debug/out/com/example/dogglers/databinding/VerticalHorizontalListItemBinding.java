...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull CardView rootView, @NonNull TextView dogAge,
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VerticalHorizontalListItemBinding((CardView) rootView, dogAge, dogHobbies,
          dogImage, dogName);
    }
